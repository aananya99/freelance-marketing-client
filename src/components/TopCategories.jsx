      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        <div className="card bg-base-100 w-full shadow-lg">
          <div className="card-body">
            ...
            <p>
              Enhance your online presence with responsive websites, optimized
              performance, and seamless user experiences. Leverage modern web
              technologies and best practices to build scalable, secure, and
              visually engaging web solutions that drive growth and captivate
              your audience.
            </p>
          </div>
          <figure>
